...
MUTOS 1700 was the standard operating system for the East German (DDR) office computers **Robotron A7100** and **A7150**. While it is binary- and architecture-compatible with **Version 7 Unix (V7)**, it targets a 16-bit x86 architecture (Intel 8086 / K1810WM86).
